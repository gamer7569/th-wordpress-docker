...
<body>
    ...
    <main id="main" class="container" role="main">
        ...
        <div style="-webkit-column-count:3;">
            <div>
                <a href="https://github.com/gamer7569/th-wordpress-docker/blob/master/readme.md">
                    th-wordpress-docker
                </a>
            </div>
            <div>
            ...
            <div>
                <a href="https://gamer7569.github.io/blog/git-worklow/">
                    Git workflow
                </a>
            </div>
        </div>
    ...
    <footer class="container">
        <hr />
        <p class="text-center">
            Maintained by <a href="https://townhallmedia.com">Matt Williams</a>
        </p>
    </footer>
